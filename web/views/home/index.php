            ...
            <div class="row oferta-content">
                <div class="col-lg-4">
                    <div class="oferta-card">
                        <img src="/assets/img/oil.png" class="oferta-img-top rounded-circle" alt="...">
                ...
                <div class="col-lg-4">
                    <div class="oferta-card">
                        <img src="/assets/img/clima.png" class="oferta-img-top rounded-circle" alt="...">
                        <div class="oferta-body">
                ...
                <div class="col-lg-4">
                    <div class="oferta-card">
                        <img src="/assets/img/breakes.png" class="oferta-img-top rounded-circle" alt="...">
                        <div class="oferta-body">
