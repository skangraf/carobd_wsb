 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', $_SERVER['DOCUMENT_ROOT'].'/assets/img/');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'carobd.pl service');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'carobd.pl');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'AutoService "CAROBD"');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "ul.Ogrodowa 5\n60-589 Poznań\ntel.0 800 225 052\nbiuro@carobd.pl");
